...
export const NETWORK_PROFILES: Record<Network, NetworkProfile> = {
  ...
  xlayer: {
    ...
    apiBaseUrl: process.env.NEXT_PUBLIC_XLAYER_API_PROXY || 'https://api.aoxcore.com/api/v1',
    ...
    explorerUrl: process.env.NEXT_PUBLIC_XLAYER_EXPLORER || 'https://www.oklink.com/xlayer',
    tokenAddress: process.env.NEXT_PUBLIC_AOXC_ON_XLAYER_TOKEN || '0xeb9580c3946bb47d73aae1d4f7a94148b554b2f4',
    aoxcTokenIsNativeEquivalent: true,
  },
  cardano: {
    key: 'cardano',
    ...
    apiBaseUrl: process.env.NEXT_PUBLIC_CARDANO_API_PROXY || 'https://api.aoxcore.com/api/v1',
    jsonRpcUrl: process.env.NEXT_PUBLIC_CARDANO_API || 'https://cardano-mainnet.blockfrost.io/api/v0',
    nativeCurrencySymbol: 'ADA',
    marketSymbol: process.env.NEXT_PUBLIC_CARDANO_MARKET_SYMBOL || 'ADAUSDT',
    explorerUrl: process.env.NEXT_PUBLIC_CARDANO_EXPLORER || 'https://cardanoscan.io',
  ...
  sui: {
    ...
    apiBaseUrl: process.env.NEXT_PUBLIC_SUI_API_PROXY || 'https://api.aoxcore.com/api/v1',
    ...
    explorerUrl: process.env.NEXT_PUBLIC_SUI_EXPLORER || 'https://suivision.xyz',
    aoxcTokenIsNativeEquivalent: false,
  },
};
